...
GA::GA( int pop ){
  ...
  mutation_range = 0.05; // This parameter is the range that a mutated value can fall in. The distribution is a gausian centered on the old value in the genome.
